...
powershell -Command "((new-object net.webclient).DownloadFile('https://download.microsoft.com/download/0/A/F/0AFB5316-3062-494A-AB78-7FB0D4461357/windows6.1-KB976932-X64.exe', '%TEMP%\windows6.1-KB976932-X64.exe'))
...
%TEMP%\windows6.1-KB976932-X64.exe /unattend
